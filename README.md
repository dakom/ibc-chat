...
* [Auto-generated Rustdoc](https://dakom.github.io/ibc-chat/doc/shared/) for all shared types, contract messages, including IBC and events (from the `shared` package)
* Fullstack Rust, types are shared between contracts, cli, and frontend!! (all powered by wasm too :))
...
Debugging individual chains by shell can be done via `task chain-sh-[neutron | kujira | stargaze | wasmd]`.
