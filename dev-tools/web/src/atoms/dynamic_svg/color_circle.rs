use dominator::svg;
use crate::{atoms::buttons::ButtonSize, locale::LOCALE, prelude::*};

pub struct ColorCircle {
}

impl ColorCircle {
    pub fn render(size: ButtonSize, color: impl Signal<Item = ColorSemantic> + 'static) -> Dom {
        static SMALL_CLASS:Lazy<String> = Lazy::new(|| {
            class! {
                .style("width", "1rem")
                .style("height", "1rem")
            }
        ...
        static LARGE_CLASS:Lazy<String> = Lazy::new(|| {
            class! {
                .style("width", "2rem")
                .style("height", "2rem")
            }
